...
Purpose: Utility routines for matrix construction, extrapolation,
         special functions, kernel generation, and windowing
Language: C
*/
//==========================================================================
...
#include "utils.h"
/*
Diagonal matrix construction routine:
*/
...
/*
Log-linear extrapolation routine:
*/
...
/*
Bilinear extrapolation routine:
*/
...
/*
Zero-padding 2D extrapolation routine:
...
/*
Lanczos Gamma-function routine:

This routine evaluates the Gamma function for complex arguments
...
/*
Asymptotic log-ratio Gamma helper routine:
...
/*
Two-dimensional complex window routine:
*/
