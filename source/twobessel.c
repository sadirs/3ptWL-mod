...
/*
============================================================================
NAME: twobessel.c                            [wlcf]
Written by: S. Aviles et al.
Starting date: February 2026
Purpose: Two-dimensional spherical/Bessel transform routines using FFTW
Language: C
*/
//==========================================================================
...
#include "twobessel.h"
/*
Two spherical-Bessel transform routine:
*/
void two_sph_bessel(double *k1, double *k2, double **fk1k2, long N1,
...
/*
Bin-averaged two spherical-Bessel transform routine:

*/
void two_sph_bessel_binave(double *k1, double *k2, double **fk1k2,
...
/*
Bin-averaged two Bessel transform routine:
